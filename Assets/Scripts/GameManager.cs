...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField] private float timerStart = 0, timerAux = 10;
    ...
    private void Update()
    {
        ...
        if (timerStart <= 0 && vidas > 0 && !(SceneManager.GetActiveScene().name == "Menu")) {
            jugador.transform.localScale = new Vector3(1.5f, jugador.transform.localScale.y, jugador.transform.localScale.z);
        }
    }
    ...
    public void doubleUp()
    {
        ...
        {
            timerStart = timerAux;
            jugador.transform.localScale = new Vector3(jugador.transform.localScale.x * 2, jugador.transform.localScale.y, jugador.transform.localScale.z);
        }
        else {
            timerStart = timerAux;
        }
